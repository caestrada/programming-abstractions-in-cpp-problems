...
/*
 * Implementation notes: leftFrom, righFrom
 * ----------------------------------------
 ...
 * adding 3 achieves the same effect but ensures that the values remain 
 * positive.
 */
 ...
 * ---------------------------------------
 * Most C++ compilers require the default cause to make sure that this function
 * always returns a string, even if the direction is not one of the legal 
 * values.
 */
