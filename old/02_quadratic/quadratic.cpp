/**
 * @file quadratic.cpp
 * @author Carlos Estrada (cestr008.dev@gmail.com)
 * @brief This program finds roots of the quadratic equation
 *          2
 *      a x    +  b x  +  c  =   0
 * 
 ...
 */
void getCoefficients(double &a, double &b, double &c) {
    cout << "Enter coefficients for the quadradic equation:" << endl;
    cout << "a: ";
    cin >> a;
    cout << "b: ";
    cin >> b;
